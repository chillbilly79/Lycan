...
namespace Lycan.Extensions.Broker.Abstractions.Model
{
    public class MutualFund
    {
        ...
        [JsonPropertyName("nAV")] public int NAV { get; set; }

        [JsonPropertyName("peRatio")] public int PeRatio { get; set; }

        [JsonPropertyName("divAmount")] public int DivAmount { get; set; }

        [JsonPropertyName("divYield")] public int DivYield { get; set; }
