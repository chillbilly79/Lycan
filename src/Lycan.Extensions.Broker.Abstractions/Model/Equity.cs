...
namespace Lycan.Extensions.Broker.Abstractions.Model
{
    ...
    public class Equity
    {
        ...
        [JsonPropertyName("assetMainType")] public string AssetMainType { get; set; }
        ...
        [JsonPropertyName("openPrice")] public double OpenPrice { get; set; }

        [JsonPropertyName("highPrice")] public double HighPrice { get; set; }

        [JsonPropertyName("lowPrice")] public double LowPrice { get; set; }

        [JsonPropertyName("bidTick")] public string BidTick { get; set; }

        [JsonPropertyName("closePrice")] public double ClosePrice { get; set; }

        [JsonPropertyName("netChange")] public double NetChange { get; set; }

        [JsonPropertyName("totalVolume")] public int TotalVolume { get; set; }

        [JsonPropertyName("quoteTimeInLong")] public long QuoteTimeInLong { get; set; }

        [JsonPropertyName("tradeTimeInLong")] public long TradeTimeInLong { get; set; }
        ...
        [JsonPropertyName("52WkHigh")] public double _52WkHigh { get; set; }

        [JsonPropertyName("52WkLow")] public double _52WkLow { get; set; }

        [JsonPropertyName("nAV")] public double NAV { get; set; }

        [JsonPropertyName("peRatio")] public double PeRatio { get; set; }

        [JsonPropertyName("divAmount")] public double DivAmount { get; set; }

        [JsonPropertyName("divYield")] public double DivYield { get; set; }

        [JsonPropertyName("divDate")] public string DivDate { get; set; }
