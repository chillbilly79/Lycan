...
namespace Lycan.Api.Model.Response
{
    public class FutureOptions    {
        ...
        [JsonPropertyName("deltaInDouble")]
        public int DeltaInDouble { get; set; } 

        [JsonPropertyName("gammaInDouble")]
        public int GammaInDouble { get; set; } 

        [JsonPropertyName("thetaInDouble")]
        public int ThetaInDouble { get; set; } 

        [JsonPropertyName("vegaInDouble")]
        public int VegaInDouble { get; set; } 

        [JsonPropertyName("rhoInDouble")]
        public int RhoInDouble { get; set; } 
